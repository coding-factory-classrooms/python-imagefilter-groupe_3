...
try:
    ...
    if args[1] == "--filters":
        ...
        print("Voici les différentes commandes : \n"
              "-h : pour de l'aide \n"
              "--filters : pour faire les différents filtres suivi du ou des filtres suivants: \n"
              "dilate: suivi de l'intensité de la dilatation \n"
              "blur: suivi de l'intensité du flou (un nombre positif impaire)\n"
              "grayscale:\n")
